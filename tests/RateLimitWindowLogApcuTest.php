 ...
 * 
 * @example ./vendor/bin/phpunit --verbose tests/RateLimitWindowLogApcuTest.php
 */
class RateLimitWindowLogApcuTest extends AbstractTestCase {
    ...
    public function testAllowedReturnsTrueAfterWindowExpires(): void {
        ...
        $limiter = AbstractRateLimiterService::factory(CacheEnum::APCU, null, AlgorithmStrategyEnum::SLIDING_LOG);
